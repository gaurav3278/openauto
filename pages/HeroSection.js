...
const HeroSection = () => {
  return (
    <div className="flex w-full h-full">
      <div className="flex bg-gray-300/30 w-full  p-8 relative  ">
      ...
      <div className="flex flex-col  mt-36">
        <div className="flex p-5 items-start  mt-5 w-2/4 sm:w-full  ">
        ...
        <div className="flex sm:flex-col justify-around gap-2 pl-5">
          {/* 1 */}
